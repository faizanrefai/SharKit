...
#define SHKFacebookKey				@"434029279956341"
#define SHKFacebookSecret			@"9db406ea70a54d7afd9d14812bd854ab"
 ...
 */
#define SHKTwitterConsumerKey		@"nZNdVZYlcL0olT1E9a2doQ"
#define SHKTwitterSecret			@"SWEz8gqGPPSNB6R5eDlgqyVDRqIcMy21yC4wwSf89eY"
#define SHKTwitterCallbackUrl		@"http://www.demo.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
